...
<node TEXT="ALAIN FERNÁNDEZ FERNÁNDEZ" ID="ID_1051326097" CREATED="1347288993817" MODIFIED="1359900422093" STYLE="bubble">
<font NAME="Arial Narrow" SIZE="12" BOLD="true"/>
</node>
</node>
...
<node TEXT="su sintaxis es muy parecida a la de Java o C/C++" ID="ID_686849354" CREATED="1361585013553" MODIFIED="1414434456186">
...
<node TEXT="los nombres de las $variables comienzan por el símbolo $ y pueden delimitarse &quot;así&quot; ó &apos;así&apos;" ID="ID_214476431" CREATED="1361585080402" MODIFIED="1602064986656"/>
...
<node TEXT="hay arrays &quot;asociativos&quot;, en los que el índice del array es un String, a modo de identificador, asociado a un valor" ID="ID_1579190044" CREATED="1361585116547" MODIFIED="1361585139245"/>
</node>
</node>
...
<node TEXT="&lt;?php&#xa;    echo &quot;El resultado es &quot; . (17+5);&#xa;?&gt;" ID="ID_959519817" CREATED="1602060175917" MODIFIED="1602064105501"/>
</node>
...
<node TEXT="XAMPP" ID="ID_989182814" CREATED="1411583798507" MODIFIED="1521139803570">
...
<node TEXT="Apache" FOLDED="true" ID="ID_1643550115" CREATED="1381169475460" MODIFIED="1574682425559">
<icon BUILTIN="button_cancel"/>
<node TEXT="configurar la raíz&#xa;del servidor Apache" ID="ID_315604316" CREATED="1365100369462" MODIFIED="1521139803557">
...
<node TEXT="y luego &quot;Apache (httpd.conf)&quot;" ID="ID_1754717887" CREATED="1381169534411" MODIFIED="1411582801910"/>
</node>
<node TEXT="se abrirá un fichero de texto de configuración" ID="ID_66927984" CREATED="1381169562288" MODIFIED="1381169571572"/>
<node TEXT="bajar alguna pantalla hasta la opción DocumentRoot (buscad &quot;DocumentRoot&quot;)" ID="ID_999700246" CREATED="1381169572452" MODIFIED="1442856721294"/>
...
<node TEXT="DocumentRoot &quot;X:/ASIR2/IAW/www&quot;" ID="ID_697993151" CREATED="1381169602234" MODIFIED="1411582856494">
...
<node TEXT="&lt;Directory &quot;X:/ASIR2/IAW/www&quot;&gt;" ID="ID_1345826450" CREATED="1381169763653" MODIFIED="1411582883261">
<icon BUILTIN="z_application_xp_terminal"/>
</node>
</node>
</node>
...
<node TEXT="en PhpStorm" ID="ID_1260667347" CREATED="1360941356697" MODIFIED="1446578941110">
...
<node TEXT="ejecutar ese primer script, pulsando en el icono de Chrome que sale arriba a la derecha" ID="ID_170984960" CREATED="1360941430212" MODIFIED="1574683710339">
...
<node TEXT="configurar xDebug" ID="ID_933652686" CREATED="1575289547718" MODIFIED="1575289553309">
...
<node TEXT="phpmyadmin" ID="ID_552951245" CREATED="1575976853373" MODIFIED="1575976858245">
...
<node TEXT="Object" ID="ID_1579518485" CREATED="1380221545681" MODIFIED="1380221547270"/>
<node TEXT="NULL" ID="ID_1674374450" CREATED="1380221547481" MODIFIED="1411577933685">
<icon BUILTIN="button_ok"/>
</node>
...
<node TEXT="if (isset($_REQUEST[&quot;parametro&quot;])) { ... }" ID="ID_1438079780" CREATED="1442862895157" MODIFIED="1602066423238">
<icon BUILTIN="atenciвn_!"/>
</node>
</node>
</node>
...
<node TEXT="esto sería &quot;Si A MÁS UNO vale 10...&quot;" ID="ID_561831442" CREATED="1411579023868" MODIFIED="1521139803409">
...
<icon BUILTIN="button_cancel"/>
<node TEXT="if ($a++ == 10) ..." ID="ID_1486291735" CREATED="1396287991078" MODIFIED="1521139803404">
<node TEXT="esto sería &quot;Si SUMEMOS UNO A A vale 10...&quot; (wtf??)" ID="ID_1532424372" CREATED="1411579023868" MODIFIED="1521139803405">
...
<node TEXT="una variable es utilizable en toda la misma página PHP pero NO se conserva su valor o su existencia de una ejecución a otra" ID="ID_1530845491" CREATED="1275122818608" MODIFIED="1574766632603"/>
...
<node TEXT="define(&quot;TAMANNO_TABLERO&quot;, 17);" ID="ID_1211516746" CREATED="1574767368559" MODIFIED="1574767403557"/>
...
<node TEXT="if (expr) &lt;sentencia&gt;;&#xa;else &lt;sentencia&gt;;" ID="ID_428991954" CREATED="1411580103403" MODIFIED="1411580109200"/>
<node TEXT="if (expr) {&#xa;  &lt;sentencia(s)&gt;;&#xa;}" ID="ID_222309292" CREATED="1319453302235" MODIFIED="1380222346664"/>
<node TEXT="if (expr) {&#xa;  &lt;sentencia(s)&gt;;&#xa;} else {&#xa;  &lt;sentencia(s)&gt;;&#xa;}" ID="ID_1473828453" CREATED="1319453302235" MODIFIED="1396289127778"/>
<node TEXT="if (expr) {&#xa;  &lt;sentencia(s)&gt;;&#xa;} else if (expr) {&#xa;  &lt;sentencia(s)&gt;;&#xa;} else {&#xa;  &lt;sentencia(s)&gt;;&#xa;}" ID="ID_38619834" CREATED="1319453302235" MODIFIED="1445334207578"/>
<node TEXT="if (expr)&#xa;    &lt;sentencia&gt;;&#xa;else&#xa;    &lt;sentencia&gt;;" ID="ID_1014182171" CREATED="1319453004108" MODIFIED="1414434456364">
<icon BUILTIN="button_cancel"/>
<node TEXT="JAMÁS, PORQUE ES PARA LÍOS" ID="ID_335458748" CREATED="1411579871749" MODIFIED="1411579876098"/>
</node>
</node>
<node TEXT="switch" ID="ID_277202953" CREATED="1574335103388" MODIFIED="1574335106173">
...
<node TEXT="paso a paso" ID="ID_1966680005" CREATED="1379618817910" MODIFIED="1442856660727">
...
<node TEXT="for each" FOLDED="true" ID="ID_435899171" CREATED="1275124749468" MODIFIED="1521139803394">
...
<node TEXT="foreach ($array as $var)" ID="ID_1620983898" CREATED="1275124790777" MODIFIED="1579518567078">
...
<node TEXT="foreach ($array as $varIndice)" ID="ID_1167966635" CREATED="1275124809513" MODIFIED="1579518568237">
...
<icon BUILTIN="atenciвn_!"/>
<node TEXT="muy útil para ver el PHP que solicitó el usuario" ID="ID_1496428871" CREATED="1578563928422" MODIFIED="1578563951108"/>
...
<node TEXT="$listaNombres = array(&quot;Pepe Pérez&quot;, &quot;Pepe López&quot;, &quot;Tomás García&quot;); // Las claves (índices) serán 0, 1, 2..." ID="ID_802504718" CREATED="1602238230726" MODIFIED="1602238250749"/>
</node>
</node>
...
<node TEXT="(y ese índice puede ponerse CON o SIN comillas)" ID="ID_1072367797" CREATED="1275125319720" MODIFIED="1361586250728"/>
</node>
...
<node TEXT="exit();" ID="ID_1331733253" CREATED="1362150641562" MODIFIED="1521139803385">
<icon BUILTIN="button_ok"/>
...
<node TEXT="array_values($array)" FOLDED="true" ID="ID_776334686" CREATED="1383850071345" MODIFIED="1574686895901">
<icon BUILTIN="atenciвn_!"/>
...
<node TEXT="&quot;maneras de llamar&quot; a otros PHPs" FOLDED="true" POSITION="right" ID="ID_1032821341" CREATED="1416426544726" MODIFIED="1604921111707">
...
<node TEXT="$sql = &quot;SELECT id, nombre FROM categoria WHERE id&gt;? ORDER BY nombre&quot;;" ID="ID_28388962" CREATED="1576659972930" MODIFIED="1604925264113"/>
</node>
<node TEXT="luego la &quot;preparo&quot; (por seguridad)&#xa;(&quot;conviertir string a objeto&quot;)" ID="ID_841518484" CREATED="1604925264746" MODIFIED="1604925281362">
<node TEXT="$select = $conexion-&gt;prepare($sql);" ID="ID_350253790" CREATED="1604925273428" MODIFIED="1604925291812"/>
</node>
...
<node TEXT="$select-&gt;execute([]);" ID="ID_750262611" CREATED="1576659972932" MODIFIED="1604925370094"/>
<node TEXT="$select-&gt;execute([&quot;jlopez&quot;, &quot;abc123&quot;]);" ID="ID_1452280065" CREATED="1576659972932" MODIFIED="1604925367915"/>
</node>
...
<node TEXT="$rs = $select-&gt;fetchAll();" ID="ID_663883666" CREATED="1604925397498" MODIFIED="1604925399001"/>
</node>
...
<node TEXT="count($_COOKIE) &gt; 0" ID="ID_1324753031" CREATED="1575369668630" MODIFIED="1575369669948">
...
<node TEXT="no puedo hacer un solo echo() antes de esto" ID="ID_471566727" CREATED="1275126290076" MODIFIED="1386012177393">
<icon BUILTIN="atención_!"/>
</node>
</node>
...
<node TEXT="pero PUEDO guardar un número como string sin problemas" ID="ID_1155245136" CREATED="1417636312335" MODIFIED="1524680799049"/>
</node>
...
<node TEXT="esto CARGA la variable $_SESSION" ID="ID_1939254203" CREATED="1385063359202" MODIFIED="1385063369663">
<icon BUILTIN="atención_!!"/>
</node>
</node>
</node>
...
<node TEXT="$_SESSION" ID="ID_845514511" CREATED="1275129546788" MODIFIED="1575971905149">
...
<node TEXT="session_destroy(); " ID="ID_575541396" CREATED="1385051228347" MODIFIED="1575971662863">
<icon BUILTIN="full-2"/>
...
<node TEXT="esquema básico de&#xa;uso de sesiones con&#xa;identificador y contraseña" FOLDED="true" POSITION="right" ID="ID_602473421" CREATED="1385063975349" MODIFIED="1575972005002">
...
<node TEXT="es buena idea llamarla _comprobar-sesion.php e incluirla al principio con un require_once" ID="ID_1862222769" CREATED="1385064036173" MODIFIED="1385064597455"/>
</node>
<node TEXT="esa parte común&#xa;(_comprobar-sesion.php)&#xa;hará lo siguiente" ID="ID_1120016012" CREATED="1385064063597" MODIFIED="1575972256013">
<node TEXT="lo primero:&#xa;session_start();" ID="ID_941208567" CREATED="1575972423480" MODIFIED="1575972432168">
<node TEXT="¿hay sesión-USUARIO iniciada?&#xa;¿isset($_SESSION[&quot;sesionIniciada&quot;])?" ID="ID_195206406" CREATED="1385064073589" MODIFIED="1575972415114">
...
<node ID="ID_1548668521" CREATED="1576754953533" MODIFIED="1576754953533"><richcontent TYPE="NODE">
...
<node TEXT="redirigimos a iniciar-sesion.php" ID="ID_1356996370" CREATED="1385064260476" MODIFIED="1385064278314">
<icon BUILTIN="forward"/>
</node>
</node>
</node>
...
<node TEXT="¿viene en $_REQUEST un formulario&#xa;de inicio de sesión enviado?&#xa;¿(isset($_REQUEST[&quot;identificador&quot;]))?" ID="ID_601479278" CREATED="1385064155469" MODIFIED="1521139803176">
...
<node TEXT="$_SESSION[&quot;sesionIniciada&quot;] = true; // Nos anotamos que ESTE navegador tiene iniciada la sesión." ID="ID_484139654" CREATED="1385064314515" MODIFIED="1575974492839"/>
<node TEXT="$_SESSION[&quot;identificador&quot;] = $identificador; // Nos anotamos QUIÉN es el usuario que tiene iniciada la sesión (con esto bastaría, en realidad)." ID="ID_113238545" CREATED="1385064314515" MODIFIED="1575974492838"/>
...
<node TEXT="y, SI HAN MARCADO EL CHECKBOX DE RECORDAR, creamos un código cookie y se lo enviamos al cliente en una cookie junto con otra cookie con su identificador." ID="ID_291537071" CREATED="1576752547974" MODIFIED="1576752568514"/>
...
<node TEXT="redirigimos a iniciar-sesion.php" ID="ID_1165746358" CREATED="1385064260476" MODIFIED="1521139803194">
<icon BUILTIN="forward"/>
...
<node TEXT="redirigimos a iniciar-sesion.php" ID="ID_1458143120" CREATED="1385064260476" MODIFIED="1385064278314">
<icon BUILTIN="forward"/>
</node>
</node>
</node>
...
<icon BUILTIN="z_script"/>
<node TEXT="&lt;?php&#xa;abstract class ParentClass {&#xa;  // Abstract method with an argument&#xa;  abstract protected function prefixName($name);&#xa;}&#xa;&#xa;class ChildClass extends ParentClass {&#xa;  public function prefixName($name) {&#xa;    if ($name == &quot;John Doe&quot;) {&#xa;      $prefix = &quot;Mr.&quot;;&#xa;    } elseif ($name == &quot;Jane Doe&quot;) {&#xa;      $prefix = &quot;Mrs.&quot;;&#xa;    } else {&#xa;      $prefix = &quot;&quot;;&#xa;    }&#xa;    return &quot;{$prefix} {$name}&quot;;&#xa;  }&#xa;}&#xa;&#xa;$class = new ChildClass;&#xa;echo $class-&gt;prefixName(&quot;John Doe&quot;);&#xa;echo &quot;&lt;br&gt;&quot;;&#xa;echo $class-&gt;prefixName(&quot;Jane Doe&quot;);&#xa;?&gt;" ID="ID_1767689977" CREATED="1579078237817" MODIFIED="1579678943884"/>
</node>
</node>
...
<node TEXT="herencia simple + interfaces: &quot;traits&quot; (=rasgos)" ID="ID_1315464053" CREATED="1579078333958" MODIFIED="1579078402388"/>
<node TEXT="los traits de PHP sí permiten métodos implementados" ID="ID_281059071" CREATED="1579078402735" MODIFIED="1579078411168">
